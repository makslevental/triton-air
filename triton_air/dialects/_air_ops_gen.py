...
from triton_mlir_bindings.dialects._ods_common import extend_opview_class as _ods_extend_opview_class, \
    segmented_accessor as _ods_segmented_accessor, get_default_loc_context as _ods_get_default_loc_context, get_op_result_or_value as _get_op_result_or_value, \
...
class ChannelGetOp(_ods_ir.OpView):
    ...
    def __init__(self, async_token, async_dependencies, chan_name, indices, dst, dst_offsets, dst_sizes, dst_strides, *,
                 loc=None, ip=None):
        operands = []
        results = []
        attributes = {}
...
class ChannelPutOp(_ods_ir.OpView):
    ...
    def __init__(self, async_token, async_dependencies, chan_name, indices, src, src_offsets, src_sizes, src_strides, *,
                 loc=None, ip=None):
        operands = []
        results = []
        attributes = {}
...
class DmaMemcpyNdOp(_ods_ir.OpView):
    ...
    def __init__(self, async_token, async_dependencies, dst, dst_offsets, dst_sizes, dst_strides, src, src_offsets,
                 src_sizes, src_strides, *, loc=None, ip=None):
        operands = []
        results = []
        attributes = {}
        regions = None
