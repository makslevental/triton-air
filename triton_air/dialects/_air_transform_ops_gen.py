...
from triton_mlir_bindings.dialects._ods_common import extend_opview_class as _ods_extend_opview_class, \
  get_default_loc_context as _ods_get_default_loc_context, get_op_result_or_value as _get_op_result_or_value, \
...
class LinalgPromoteOp(_ods_ir.OpView):
    ...
    def __init__(self, transformed, target, *, operands_to_promote=None, group_size=None, use_full_tile_buffers=None,
                 use_full_tiles_by_default=None, use_alloca=None, alignment=None, memory_space=None, loc=None, ip=None):
        operands = []
        results = []
        attributes = {}
        regions = None
        ...
        if group_size is not None: attributes["group_size"] = (group_size if (
                ...
                not _ods_ir.AttrBuilder.contains('I64Attr')) else
                                                               _ods_ir.AttrBuilder.get('I64Attr')(group_size,
                                                                                                  context=_ods_context))
        ...
        if alignment is not None: attributes["alignment"] = (alignment if (
                ...
                not _ods_ir.AttrBuilder.contains('I64Attr')) else
                                                             _ods_ir.AttrBuilder.get('I64Attr')(alignment,
                                                                                                context=_ods_context))
        if memory_space is not None: attributes["memory_space"] = (memory_space if (
                ...
                not _ods_ir.AttrBuilder.contains('StrAttr')) else
                                                                   _ods_ir.AttrBuilder.get('StrAttr')(memory_space,
                                                                                                      context=_ods_context))
...
class LinalgTileOp(_ods_ir.OpView):
    ...
    def __init__(self, tiled_linalg_op, loops, target, dynamic_sizes, *, static_sizes=None, interchange=None, loc=None,
                 ip=None):
        operands = []
        results = []
        attributes = {}
...
class PipelineReduceOp(_ods_ir.OpView):
    ...
    def __init__(self, result, target, *, tile_size=None, pipeline_depth=None, direction=None, promote=None, loc=None,
                 ip=None):
        operands = []
        results = []
        attributes = {}
        ...
        if tile_size is not None: attributes["tile_size"] = (tile_size if (
                ...
                not _ods_ir.AttrBuilder.contains('I64ArrayAttr')) else
                                                             _ods_ir.AttrBuilder.get('I64ArrayAttr')(tile_size,
                                                                                                     context=_ods_context))
        if pipeline_depth is not None: attributes["pipeline_depth"] = (pipeline_depth if (
                ...
                not _ods_ir.AttrBuilder.contains('I64Attr')) else
                                                                       _ods_ir.AttrBuilder.get('I64Attr')(
                                                                           pipeline_depth, context=_ods_context))
        if direction is not None: attributes["direction"] = (direction if (
                issubclass(type(direction), _ods_ir.Attribute) or
                not _ods_ir.AttrBuilder.contains('StrAttr')) else
                                                             _ods_ir.AttrBuilder.get('StrAttr')(direction,
                                                                                                context=_ods_context))
